...
// Gulp task default
//===========================================
gulp.task('default', ['sass:build','js:build','jsMain:build','webServer','watch']);
//===========================================
gulp.task('html', ['html:build','sass:build','js:build','jsMain:build','webServer','watchHtml']);
//===========================================
gulp.task('pug', ['pug:build','sass:build','js:build','jsMain:build','webServer','watchPug']);
//===========================================
gulp.task('php', ['sass:build','js:build','jsMain:build','openServer','watchPhp']); // only with php server
//===========================================
